...
const OPERATIONAL_TABLE = /^(schema_migrations|semantic_|ingestion_|document_chunks$|knowledge_candidates$|review_decisions$|wiki_|conversations$|messages$|conversation_context$|agent_|tool_calls$|evidence_records$|idempotency_keys$|evaluation_)/;
